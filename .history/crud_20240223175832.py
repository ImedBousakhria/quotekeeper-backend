...
# User login
def authenticate_user(username: str, password: str, db: Session = Depends(database.get_db)) -> Optional[models.User]:
def authenticate_user(username: str, password: str, db: Session = Dep