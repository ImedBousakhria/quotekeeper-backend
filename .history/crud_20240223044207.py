...
def get_bookmarks(db:Session, skip:int=0, limit:int=100):
    """
    Get all Bookmarks from database with pagination.
     - `skip`: Number of records to be skipped. Used for pagination. Default is 0 i.e., no record will be skipped
     - `skip`: Number of records to be skipped. Used for pagination. Default is 0.
     - `limit`: Maximum number of records to be returned. Default is 100.   
